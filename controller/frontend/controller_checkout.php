...
class controller_checkout
{
	...
	public function __construct()
	{
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			$order_id = $this->model->execute_return_id("insert into tbl_muahang set customer_id=$customer_id, hoten='$hoten',diachi='$diachi',sdt='$sdt',ghichu='$ghichu',ngaymua=now(),trangthai=0 ");
